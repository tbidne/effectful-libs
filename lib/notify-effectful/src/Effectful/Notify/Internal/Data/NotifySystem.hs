...
module Effectful.Notify.Internal.Data.NotifySystem
...
import Effectful.Notify.Internal.Os (Os)
import Effectful.Notify.Internal.Os qualified as Os
...
-- 'NotifySystemOs'. Useful for obtaining a valid system for the current
