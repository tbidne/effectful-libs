...
module Effectful.Notify.Internal.Data.Note
  ( Note,
    mkNote,
    setBody,
    getBody,
...
import Effectful.Notify.Internal.Data.NotifyTimeout (NotifyTimeout)
import Effectful.Notify.Internal.Data.NotifyUrgency (NotifyUrgency)
