...
module Effectful.Notify.Internal.Data.NotifyEnv
  ( NotifyEnv (..),
    notifyEnvToSystemOs,
  )
where
...
import Effectful.Notify.Internal.Data.NotifySystem (NotifySystemOs)
import Effectful.Notify.Internal.Data.NotifySystem qualified as System
